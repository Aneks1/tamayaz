		...
		<div class="flex items-center justify-between">
			...
			<div class="lg:hidden flex flex-row gap-4">
				<a class="btn btn-ghost btn-circle" href="/cart">
					...
					<a
						href="/signin"
						@click="isOpen = false"
						class="btn bg-xprimary hover:bg-xaccent border-0 px-2 rounded text-xprimary-content font-semibold"
						>Sign In</a
					>
				<button @click="drawer">
					<svg
			...
			>
				...
				<ul class="font-sans">
					...
					<li>
						<a href="/streams" @click="isOpen = false" class="my-4 inline-block"
							>Series</a
						>
					</li>
					<li>
